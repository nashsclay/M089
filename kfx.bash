...
while [  $COUNTER -lt $MNCOUNT ]; do
 ...
 RPCPORT=$(($RPCPORT+$COUNTER))
  ...
  echo "maxconnections=$MAXC" >> kfx.conf_TEMP
  ...
  echo "" >> kfx.conf_TEMP
  echo "addnode=45.77.252.62:15858" >> kfx.conf_TEMP
  echo "addnode=45.77.226.43:15858" >> kfx.conf_TEMP
  echo "addnode=45.76.150.140:15858" >> kfx.conf_TEMP
  echo "addnode=45.63.92.158:15858" >> kfx.conf_TEMP
